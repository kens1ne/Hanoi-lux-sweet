            ...
            <div class="grid">
                <div class="grid-column-4">
                    <div class="box-hover">
                        ...
                        <a href=""><img width="350" src="../public/img/rooms/room2.jpg" alt="" class="img-change"></a>
                    </div>
                ...
                <div class="grid-column-4">
                    <div class="box-hover">
                        ...
                        <a href=""><img width="350" src="../public/img/rooms/room4.jpg" alt="" class="img-change"></a>
                    </div>
                    <!-- <div class="point">9</div> -->
                    <h3 class="product-title">Vuon Xuan Hotel</h3>
                    <div class="star">
                ...
                <div class="grid-column-4">
                    <div class="box-hover">
                        ...
                        <a href=""><img width="350" src="../public/img/rooms/room7.jpg" alt="" class="img-change"></a>
                    </div>
                    <!-- <div class="point">9</div> -->
                    <h3 class="product-title">Vuon Xuan Hotel</h3>
                    <div class="star">
                ...
                <div class="grid-column-4">
                    <div class="box-hover">
                        ...
                        <a href=""><img width="350" src="../public/img/rooms/room9.jpg" alt="" class="img-change"></a>
                    </div>
                    <!-- <div class="point">9</div> -->
                    <h3 class="product-title">Vuon Xuan Hotel</h3>
                    <div class="star">
                ...
                <div class="grid-column-4">
                    <div class="box-hover">
                        ...
                        <a href=""><img width="350" src="../public/img/rooms/room.jpg" alt="" class="img-change"></a>
                    </div>
                    <!-- <div class="point">9</div> -->
                    <h3 class="product-title">Vuon Xuan Hotel</h3>
                    <div class="star">
