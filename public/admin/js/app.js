		...
		document.getElementById("header-lang-img") &&
			("en" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/us.svg")
				: "sp" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/spain.svg")
				: "gr" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/germany.svg")
				: "it" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/italy.svg")
				: "ru" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/russia.svg")
				: "ch" == e
				? (document.getElementById("header-lang-img").src =
						"client/images/flags/china.svg")
				: "fr" == e &&
				  (document.getElementById("header-lang-img").src =
						"client/images/flags/french.svg"),
			localStorage.setItem("language", e),
			(b = localStorage.getItem("language")),
			(function () {
				null == b && y(g);
				var e = new XMLHttpRequest();
				e.open("GET", "client/lang/" + b + ".json"),
	...
	function f() {
		...
		!a ||
			...
			((o = document.createElement("ul")).innerHTML =
				'<a href="#" class="logo"><img src="client/images/logo-sm.png" alt="" height="22"></a>'),
			document
