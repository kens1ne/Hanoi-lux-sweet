...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="index.php?act=addcate"><i class='app-menu__icon bx bx-id-card'></i> <span
            class="app-menu__label">Danh Mục Phòng</span></a></li>

      <li><a class="app-menu__item" href="index.php?act=addroom"><i
            class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Quản Lý Phòng</span></a>
      </li>

      <li><a class="app-menu__item" href="index.php?act=addkh"><i class='app-menu__icon bx bx-user-voice'></i><span
            class="app-menu__label">Quản Lý Đặt Phòng</span></a></li>
      ...
      <li><a class="app-menu__item" href="index.php?act=listtk"><i class='app-menu__icon bx bx-run'></i><span
            class="app-menu__label">Thống kê Phòng</span></a></li>
